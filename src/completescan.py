...
# import novaclient.client as nov_client
import neutronclient.neutron.client
# import neutronclient.neutron.client as neu_client
...
class CompleteScan(Resource):
    def get(self):
        ...
        # keystone authenticator package ka identity class
        # what is from ___ <-- what is this ?
        ...
        # nova = nov_client.Client(2, session=sess)   even this should work i think.
        ...
        # neutc = neu_client.Client('2.0', session=sess)
